...
var walker1_node = props.globals.getNode("sim/model/npc[1]", 1);
var w1_animate_node = props.globals.getNode("sim/model/npc[1]/animate", 1);
var w1_loop_enabled_node = props.globals.getNode("sim/model/npc[1]/loop-enabled", 1);
var w1a_enabled_current_node = props.globals.getNode("sim/model/npc[1]/animate/enabled-current", 1);
var w1a_dialog_position_node = props.globals.getNode("sim/model/npc[1]/animate/dialog-position", 1);
var w1a_list_node = props.globals.getNode("sim/model/npc[1]/animate/list", 1);
var w1a_sequence_selected_node = props.globals.getNode("sim/model/npc[1]/animate/sequence-selected", 1);
var sequence_node = w1a_list_node.getNode("sequence[" ~ w1a_sequence_selected_node.getValue() ~ "]", 1);
var triggered_seq_node = nil;
var trigger_standing_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/standing", 1);
var trigger_walking_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/walking", 1);
var trigger_running_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/running", 1);
var trigger_backwards_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/backwards", 1);
var trigger_falling_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/falling", 1);
var trigger_landing_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/landing", 1);
var trigger_open_parachute_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/open-parachute", 1);
var trigger_crashing_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/crashing", 1);
var trigger_free1_node = props.globals.getNode("sim/model/npc[1]/animate/triggers/free1", 1);
...
aircraft.data.add("sim/model/npc[1]/animate/enabled-triggers");
...
var sequence = {
	new_animation:	func (name) {
		...
		var new_sequence = props.globals.getNode("sim/model/npc[1]/animate/list/sequence[" ~ size(w1a_list_node.getChildren("sequence")) ~ "]", 1);
	...
	edit_animation:	func {
		...
		setprop("sim/model/npc[1]/animate/enabled-triggers", 0);
...
#					print ("found trigger ",j," ",trigger_in," at ",i);
		...
		box.set("property", "sim/model/npc[1]/animate/enabled-triggers");
...
var animate = {
	...
	reset_position:	func {
		setprop("sim/model/npc[1]/name", "");
		setprop("sim/model/npc[1]/limb[0]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[0]/z-m", 0.0);
		setprop("sim/model/npc[1]/limb[1]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[1]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[2]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[2]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[3]/x-deg", -80.0);
		setprop("sim/model/npc[1]/limb[3]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[3]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[4]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[4]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[5]/x-deg", 0.0);
		setprop("sim/model/npc[1]/limb[5]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[5]/hand-pose", 0.0);
		setprop("sim/model/npc[1]/limb[6]/x-deg", -80.0);
		setprop("sim/model/npc[1]/limb[6]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[6]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[7]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[7]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[8]/x-deg", 0.0);
		setprop("sim/model/npc[1]/limb[8]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[8]/hand-pose", 0.0);
		setprop("sim/model/npc[1]/limb[9]/x-deg", 0.0);
		setprop("sim/model/npc[1]/limb[9]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[9]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[10]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[11]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[12]/x-deg", 0.0);
		setprop("sim/model/npc[1]/limb[12]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[12]/z-deg", 0.0);
		setprop("sim/model/npc[1]/limb[13]/y-deg", 0.0);
		setprop("sim/model/npc[1]/limb[14]/y-deg", 0.0);
		w1_loop_enabled_node.setValue(1);
		setprop("sim/model/npc[1]/loop-to", 0);
		setprop("sim/model/npc[1]/rest-sec", 0.0);
		setprop("sim/model/npc[1]/transit-sec", 1.0);
		setprop("sim/model/npc[1]/trigger-upon", "Disabled");
	...
	showDialog: func {
		...
		content.set("editable", 1);
		content.set("live", 1);
		content.set("property", "sim/model/npc[1]/animate/dialog-position");
		content.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		content.set("editable", 1);
		content.set("live", 1);
		content.set("property", "sim/model/npc[1]/name");
		content.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		content.prop().getNode("binding[0]/object-name", 1).setValue("input");
...
#		content.prop().getNode("binding[1]/value", 1).setValue(1);
		...
		box.set("name", "Hip 0y");
		box.set("property", "sim/model/npc[1]/limb[0]/y-deg");
		...
		number.set("property", "sim/model/npc[1]/limb[0]/y-deg");
		...
		box.set("property", "sim/model/npc[1]/limb[0]/z-m");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[0]/z-m");
		number.set("pref-width", 32);
		...
		box.set("property", "sim/model/npc[1]/limb[1]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[1]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[1]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[1]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[2]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[2]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[2]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[2]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[3]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[3]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[3]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[3]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[3]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[3]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
#		box.set("property", "sim/model/npc[1]/limb[4]/y-deg");
...
#		g.addChild("empty").set("stretch", 1);
#		var number = g.addChild("text");
#		number.set("property", "sim/model/npc[1]/limb[4]/y-deg");
#		number.set("pref-width", 32);
#		number.set("format", "%6.1f");
#		number.set("live", 1);
#		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[4]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[4]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[5]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[5]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[5]/y-deg");
		box.set("legend", "counter-clockwise < > clockwise                               ");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[5]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
# hand pose start
		...
		content2.set("live", 1);
		content2.set("property", "sim/model/npc[1]/limb[5]/hand-pose");
...
# hand pose stop
		...
		box.set("property", "sim/model/npc[1]/limb[6]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[6]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[6]/y-deg");
		box.set("legend", "     counter-clockwise < > clockwise");
		box.set("pref-width", 240);
		box.set("pref-height", 16);
		box.set("live", 1);
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[6]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[6]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[6]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
#		box.set("property", "sim/model/npc[1]/limb[7]/y-deg");
#		box.set("legend", "counter-clockwise < > clockwise");
#		box.set("pref-width", 300);
#		box.set("pref-height", 16);
#		box.set("live", 1);
...
#		g.addChild("empty").set("stretch", 1);
#		var number = g.addChild("text");
#		number.set("property", "sim/model/npc[1]/limb[7]/y-deg");
#		number.set("pref-width", 32);
#		number.set("format", "%6.1f");
#		number.set("live", 1);
#		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[7]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[7]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[8]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[8]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[8]/y-deg");
		box.set("legend", "    counter-clockwise < > clockwise");
		box.set("pref-width", 233);
		box.set("pref-height", 16);
		box.set("live", 1);
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[8]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
# hand pose start
		...
		content2.set("editable", 1);
		content2.set("live", 1);
		content2.set("property", "sim/model/npc[1]/limb[8]/hand-pose");
		content2.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		content2.prop().getNode("binding[0]/object-name", 1).setValue("transit");
#		content2.prop().getNode("binding[1]/command", 1).setValue("property-assign");
#		content2.prop().getNode("binding[1]/property", 1).setValue("sim/gui/dialogs/position-modified");
...
# hand pose stop
		...
		box.set("property", "sim/model/npc[1]/limb[9]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[9]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[9]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[9]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[9]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[9]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[10]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[10]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[11]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[11]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[12]/x-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[12]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[12]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[12]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[12]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[12]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[13]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[13]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/npc[1]/limb[14]/y-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/npc[1]/limb[14]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		content1.set("live", 1);
		content1.set("property", "sim/model/npc[1]/rest-sec");
...
#		content1.prop().getNode("binding[1]/value", 1).setValue(1);
		...
		content2.set("editable", 1);
		content2.set("live", 1);
		content2.set("property", "sim/model/npc[1]/transit-sec");
		content2.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		content2.prop().getNode("binding[0]/object-name", 1).setValue("transit");
#		content2.prop().getNode("binding[1]/command", 1).setValue("property-assign");
#		content2.prop().getNode("binding[1]/property", 1).setValue("sim/gui/dialogs/position-modified");
#		content2.prop().getNode("binding[1]/value", 1).setValue(1);
		...
		box.set("live", 1);
		box.set("property", "sim/model/npc[1]/loop-enabled");
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		box.prop().getNode("binding[1]/command", 1).setValue("property-assign");
		box.prop().getNode("binding[1]/property", 1).setValue("sim/gui/dialogs/position-modified");
		box.prop().getNode("binding[1]/value", 1).setValue(1);
		...
		content.set("editable", 1);
		content.set("live", 1);
		content.set("property", "sim/model/npc[1]/loop-to");
		content.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
...
#		content.prop().getNode("binding[]/property", 1).setValue("sim/gui/dialogs/position-modified");
		...
		combo.set("live", 1);
		combo.set("property", "sim/model/npc[1]/trigger-upon");
		...
		box.set("property", "sim/model/npc[1]/animate/enabled-current");
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
...
var check_walk_animations = func {	# keyboard handling for osg version
	...
	if (triggers_enabled) {
		...
		if (!getprop("sim/npc1/airborne")) {	# on ground
			...
			if ((s != nil) and (s >= 0)) {
				triggered_seq_node = props.globals.getNode("sim/model/npc[1]/animate/list/sequence[" ~ s ~ "]", 1);
...
var discover_triggers = func (verbose) {
	...
	var trig_c = 0;
	for (var i = 0; i < a; i += 1) {
		var t = props.globals.getNode("sim/model/npc[1]/animate/list/sequence[" ~ i ~"]", 1).getNode("trigger-upon", 1).getValue();
		if (t == "Walking") {
			if (triggers_list[1] == 0) {
	...
	for (var i = 0; i <= 7; i += 1) {
		if (triggers_list[i] == 0) {
			setprop("sim/model/npc[1]/animate/triggers/" ~ triggers_names[i], -1);
		}
	}
...
var init_walker = func {
	...
	position_count = size(sequence_node.getChildren("position"));
	w1a_dialog_position_node.setValue(0);
	setlistener("sim/model/npc[1]/animate/enabled-triggers", func(n) {
	...
	aircraft.data.add("sim/model/npc[1]/animate/list/sequence[0]/trigger-upon");
	aircraft.data.add("sim/model/npc[1]/animate/list/sequence[8]/trigger-upon");
