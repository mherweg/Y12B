...
FG_HOME=/mh/dot-fgfs4  fgfs --prop:/sim/frame-rate-throttle-hz=$SIM_HZ --fg-aircraft=/mh/submodules/Aircraft --aircraft=Walker-mp  --airport=ZHCC --timeofday=noon --fg-scenery=/mh/scenery/2.0 --multiplay=in,$MP_HZ,,5004 --multiplay=out,$MP_HZ,$MP_SERVER,5000 --callsign=p4 --altitude=5009 &
